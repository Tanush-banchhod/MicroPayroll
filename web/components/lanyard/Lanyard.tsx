...
// Static asset imports — files live alongside this component
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
  ...
  type MeshLineGeometryExt = THREE.BufferGeometry & { setPoints: (points: THREE.Vector3[]) => void };
  type MeshLineRef = THREE.Mesh & { geometry: MeshLineGeometryExt };
